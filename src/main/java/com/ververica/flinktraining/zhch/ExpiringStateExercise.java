...
//import com.ververica.flinktraining.exercises.datastream_java.testing.TaxiRideTestBase.TestFareSource;
//import com.ververica.flinktraining.exercises.datastream_java.testing.TaxiRideTestBase.TestRideSource;
import com.ververica.flinktraining.exercises.datastream_java.utils.ExerciseBase;
import com.ververica.flinktraining.exercises.datastream_java.utils.MissingSolutionException;
import com.ververica.flinktraining.zhch.testing.TaxiRideTestBase.TestFareSource;
import com.ververica.flinktraining.zhch.testing.TaxiRideTestBase.TestRideSource;
...
public class ExpiringStateExercise extends ExerciseBase {
	...
	final static TaxiRide ride1 = testRide(1);
	final static TaxiFare fare1 = testFare(1);
	final static TaxiFare fare2 = testFare(2);
	...
	public static void main(String[] args) throws Exception {
		...
		TestRideSource testRides = new TestRideSource(ride1);
		TestFareSource testFares = new TestFareSource(fare1, fare2);
		ExerciseBase.rides = testRides;
		ExerciseBase.fares = testFares;
